...
def make_daily_prices_plot():
    ...
    precios_diarios = pd.read_csv('../data/data_lake/cleansed/precios-horarios.csv')
    ...
    fig_precios_diarios.savefig('../data/data_lake/business/reports/figures/daily_prices.png')
